...
class Application(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.canvas = tk.Canvas(root, height=1000, width=1480, bg='grey')
        self.canvas.pack(expand=True, side=tk.RIGHT)
...
class Widgets(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.frame = tk.Frame(height=1000, width=500)
        ...
        btn_next.pack(side=tk.TOP)
        btn_prev.pack(side=tk.TOP)
    ...
    def open_file(self):
        ...
        self.index = 0
        self.display = Application.self.canvas
        self.display.create_image(0, 0, image=self.images[self.index], anchor=tk.NW)
...
if __name__ == '__main__':
    ...
    app.pack(fill=tk.BOTH, expand=True, side=tk.RIGHT)
    widg = Widgets(root)
    widg.pack(fill=tk.BOTH, expand=True, side=tk.RIGHT)
